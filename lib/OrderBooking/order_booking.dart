...
class _OrderBookingScreenState extends State<OrderBookingScreen> {
  ...
  // Function to show the three-dot menu
  void showOrderMenu(BuildContext context, Offset position) {
      ...
      entry = OverlayEntry(
        builder: (context) => LayoutBuilder(
          builder: (context, constraints) {
            return Positioned(
              top: newPosition.dy + kToolbarHeight,
              right: min(16, constraints.maxWidth * 0.05),
              child: Material(
