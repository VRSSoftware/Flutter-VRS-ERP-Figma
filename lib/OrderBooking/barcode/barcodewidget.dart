...
//   final TextEditingController _barcodeController = TextEditingController();
//   List<Map<String, dynamic>> _barcodeResults = [];
//   List<Map<String, dynamic>> _barcodeHistory = []; // List to store history
//   List<String> addedItems = [];
//   Map<String, bool> _filters = {
//     'WSP': true,
//     'Sizes': true,
...
//               _barcodeHistory.removeWhere((entry) =>
//                   entry['timestamp']
//                       .isBefore(DateTime.now().subtract(Duration(days: 2))));
//               print(
//                   "Added barcode: $upperBarcode, addedItems: $addedItems, history: $_barcodeHistory");
//               _barcodeController.clear();
//               _noDataFound = false;
//             });
//           },
...
//     setState(() {
//       _barcodeHistory.removeWhere((entry) => entry['barcode'] == barcode);
//       addedItems.remove(barcode);
//       print("Removed barcode: $barcode, updated history: $_barcodeHistory");
//     });
//   }
...
//           if (_barcodeHistory.isNotEmpty) ...[
//             const Padding(
//               padding: EdgeInsets.all(12.0),
//               child: Text(
//                 "Barcode History (Last 2 Days):",
//                 style: TextStyle(fontWeight: FontWeight.bold),
//               ),
//             ),
//             SingleChildScrollView(
...
//                   DataColumn(label: Text("Date Scanned")),
//                   DataColumn(label: Text("Action")),
//                 ],
//                 rows: _barcodeHistory.map((entry) {
...
//                         onPressed: () => _removeBarcode(entry['barcode']),
//                       ),
//                     ),
//                   ]);
//                 }).toList(),
