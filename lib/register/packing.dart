...
class _PackingPageState extends State<PackingPage> {
  ...
  Future<void> fetchOrders({required bool isLoadMore}) async {
    ...
    try {
      final orders = await ApiService.fetchPackingRegister(
        ...
        dlvFromDate: deliveryFromDate == null ? null : deliveryFromDate.toString(),
  ...
  Widget _buildDateInput(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        floatingLabelStyle: const TextStyle(color: Color.fromRGBO(21, 101, 192, 1)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: DrawerScreen(),
      appBar: AppBar(
        title: const Text('Packing Register', style: TextStyle(color: Colors.white)),
        backgroundColor: AppColors.primaryColor,
        elevation: 1,
        leading: Builder(
      ...
      body: isLoading && registerOrderList.isEmpty
          ? Stack(
              children: [
